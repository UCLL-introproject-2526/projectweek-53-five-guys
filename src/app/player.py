...
class Player:
    def __init__(self, player):
        ...
        self.heart_img = pygame.transform.scale((pygame.image.load("assets/heart_full.png").convert_alpha()), (60,60))
        self.health_100 = pygame.transform.scale((pygame.image.load("assets/health_100.png").convert_alpha()), (250,250))
        self.health_75 = pygame.transform.scale((pygame.image.load("assets/health_75.png").convert_alpha()), (250,250))
        self.health_50 = pygame.transform.scale((pygame.image.load("assets/health_50.png").convert_alpha()), (250,250))
        self.health_25 = pygame.transform.scale((pygame.image.load("assets/health_25.png").convert_alpha()), (250,250))
