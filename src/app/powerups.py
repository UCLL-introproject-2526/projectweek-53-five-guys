...
class Heart(PowerUp):
    def __init__(self):
        self.x = random.randint(50, 1920 - 50)  # random horizontal position
        self.size = 50
        self.state = "FALLING"
        self.landed_time = 0
        self.stay_duration = 6000  # stays on platform for 6s
        self.heal_amount = 1  # gives 1 life
    ...
    def apply(self, player):
        self.state = "USED"  # mark as collected
