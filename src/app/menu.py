...
def startpage(screen, real):
    ...
    while True:
        ...
        current_bg = pygame.transform.scale(pygame.image.load(bg_files[selected_bg_index]), VIRTUAL_SIZE)
        current_bg.set_alpha(150)
        screen.blit(current_bg, (0, 0))
        bg_title = title_font.render("SELECT BACKGROUND", True, (255, 255, 255))
        screen.blit(bg_title, bg_title.get_rect(center=(screen_w // 2, char1_rect.top + 30)))
