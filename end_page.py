...
def draw_shadow_text(surface, text, font, color, center, shadow=(0, 0, 0), offset=3):
    ...
    surface.blit(shadow_surf, shadow_surf.get_rect(center=(center[0] + offset, center[1] + offset)))
...
class EndPage:
    ...
    def draw(self, surface, winner_name, mouse_pos, click):
        ...
        self.draw_button(surface, self.restart_rect, self.restart_text, mouse_pos, click)
